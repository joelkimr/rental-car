      ...
      <div className="flex flex-col justify-center items-center gap-y-20">
        ...
        <div className="w-9/12 h-auto flex flex-row space-x-16 items-center justify-center">
          <div className="flex flex-col justify-center items-center">
            <img
              alt="picture"
              src="https://ik.imagekit.io/joel/icon1.png?updatedAt=1697709103482"
            />
          ...
          <div className="flex flex-col justify-center items-center">
            <img
              alt="picture"
              src="https://ik.imagekit.io/joel/icon2.png?updatedAt=1697709103311"
            />
          ...
          <div className="flex flex-col justify-center items-center">
            <img
              alt="picture"
              src="https://ik.imagekit.io/joel/icon3.png?updatedAt=1697709103320"
            />
